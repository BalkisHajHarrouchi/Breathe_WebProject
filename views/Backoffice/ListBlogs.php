...
if (isset($_GET["removeblog"]) && !empty($_GET["removeblog"])) {
    ...
    header('location: http://localhost/projet/views/Backoffice/ListBlogs.php');
}
...
<body>
                    ...
                    <div class="recent-orders">
                        <table border="1" id="myTable">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td><?= htmlspecialchars($row['idBlog']); ?></td>
                                        <td><?= htmlspecialchars($row['titre']); ?></td>
                                        <td><?= htmlspecialchars($row['source']); ?></td>
                                        <td><?= htmlspecialchars($row["contenu"]); ?></td>
                                        <td><?= htmlspecialchars($row["categorie"]); ?></td>
                                        <td><?= htmlspecialchars($row["image"]); ?></td>
                                        <td><button class="removeBtn" onclick="removeblog(<?= htmlspecialchars($row['idBlog']); ?>)">Supprimer</button>
                                            <button class="updateBtn" onclick="updateblog(<?= htmlspecialchars($row['idBlog']); ?>)">Update</button>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        ...
                        <div class="pagination">
                            <div class="pagination-links" style="display: flex; justify-content: center; align-items: center;">
                                ...
                                for ($page = 1; $page <= $totalPages; $page++) {
                                    ...
                                    echo ' href="ListBlogs.php?page=' . $page . '">' . $page . '</a>';
                                }
                                ?>
                            </div>
                        </div>
    ...
    <script>
        ...
        const removeblog = (id) => {
            location.href =
                `http://localhost/projet/views/backoffice/ListBlogs.php?removeblog=${id}`
        }
        const updateblog = (id) => {
            location.href =
                `http://localhost/projet/views/backoffice/addBlog.php?updateblog=${id}`
        }
        const removecmnt = (id) => {
            location.href =
