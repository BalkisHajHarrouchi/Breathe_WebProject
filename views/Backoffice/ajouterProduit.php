                ...
                <div class="sales">
                    ...
                    <div class="middle">
                        <div class="left">
                            <h3>Add product</h3>
                            <table>
                                <form id="addproduit" action="addproduct.php" method="POST">
                                    <div class="input-box">
                                        ...
                                        <tr>
                                            <td><input id='nomproduit' type="text" name='nomproduit'></td>
                                            <td><label>Name</label></td>
                                            <td name="error"></td>

                                        </tr>
                                        <tr>
                                            <td><input id='typeprod' type="text" name='typeprod'></td>
                                            <td><label>type</label></td>
                                        </tr>
                                        <tr>
                                            <td><input id='prix' type="text" name='prix'></td>
                                        ...
                                        <tr>
                                            <td><input id='codeBarre' type="text" name='codeBarre'></td>
