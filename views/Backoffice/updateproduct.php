...
if (
  ...
  if (
    ...
    $produit = new produit(null, null, null, null, null, null, null, null);
    $produit->setid($_POST["idProduit"]);
    $produit->setprix($_POST["newprix"]);

    $produitc->updateproduct($produit);
            ...
            <div class="middle">
              <div class="left">
                ...
                <div class="input-box">
                  <table>
                    <?php
                    $pr = $produitc->showproduct($_GET['idProduit']);
                    ?>
                    <form id="update_product" action="" method="POST">
                      <div class="input-box">
                        <tr>
                          <td><input id='idp' type="text" name='idProduit' hidden value="<?= $_GET['idProduit'] ?>"></td>

                        </tr>
                        <tr>
                          <td><input id='nomp' type="text" value="<?= $pr['nomproduit'] ?>"></td>
                          <td><label>name</label></td>
                        </tr>
                        <tr>
                          <td><input id='prixp' type="text" name='oldprice' value="<?= $pr['prix'] ?>"></td>
                          <td><label>prix</label></td>
                        </tr>
                        <tr>
                          <td><input type="text" name='newprix'></td>
                          <td><label>prix</label></td>
                        </tr>
                      </div>
