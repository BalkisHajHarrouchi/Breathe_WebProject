...
<body>
    <div class="container">
        ...
        <main>
            ...
            <div class="crudBox">
                <h1><?= ($updateEvent === NULL) ? 'Ajouter Event' : 'Update Event' ?></h1></br>
                <div class="cudBox">
                    <form method="POST" action="Evenement.php<?= ($updateEvent !== NULL) ? "?updateEvent=" . $updateEvent["idEvent"] : ""; ?>">
                        <div class="form">
                        ...
                        <div class="afficheTab">
                            <table border="1" id="myTable">
                                <thead>
                                    ...
                                    <th col-index=5>End Date</th>

                                    <th col-index=6>Description</th>
                                    <th col-index=7>Places</th>
                                    <th col-index=8>Event price</th>

                                    <th col-index=9>Action</th>
                                    <th col-index=9>Add Tickets</th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $listEvents[$i]["dateEventStart"]; ?></td>
                                            <td><?= $listEvents[$i]["dateEventEnd"]; ?></td>
                                            <td><?= $listEvents[$i]["description"]; ?></td>
                                            <td><?= $listEvents[$i]["nbPlaces"]; ?></td>
                                            <td><?= $listEvents[$i]["prixEvent"]; ?></td>


                                            <td>
                                                <button class="danger" onclick="removeEvent(<?= $listEvents[$i]['idEvent']; ?>)">Supprimer</button></br>
                                                <button class="success" onclick="updateEvent(<?= $listEvents[$i]['idEvent']; ?>)">Update</button>
                                            </td>
                                            <td>
                                                <a href="#newTickets"><button class="primary" onclick="createTicket(<?= $listEvents[$i]['idEvent']; ?>)">Add</button></a>
                                            </td>
                ...
                <form method="post" action="" class="sort-form">
                    <select name="triT" id="triT">
                        <option value="">Tri par defaut</option>
                        <option value="idEvent">idEvent</option>

                        <option value="detailTicket" <?php $tri_choi = "detailTicket"; ?>>Ticket details</option>


                    </select>
                    <input type="submit" name="btntriT" value="TrierT" class="sortbtnT">
                </form>
                ...
                <div class="crudBox2" id="newTickets">
                    ...
                    <div class="cudBox2">
                        <form method="POST" action="Evenement.php<?= ($updateTicket !== NULL) ? "?updateTicket=" . $updateTicket["idTicket"] : ""; ?>">
                            <div class="form">
                                <input type="hidden" value="<?= ($updateTicket !== NULL) ? $updateTicket["idEvent"] : ""; ?>" name="idEvent" id="idEventInput" placeholder=" " autocomplete="off" class="form__input" oninput="checkIdEvent(this)"><br /><br />
                            </div>
        ...
        <div class="right">
            <div class="qrscanner"><a href="scannerqrcode/qrscanner.php"><img src="../balkis/img/qrcode.png"></a></div>
    ...
    <script>
        ...
        const removeEvent = (id) => {
            location.href = `http://localhost/Projet/views/Backoffice/Evenement.php?removeEvent=${id}`
        }
        const updateEvent = (id) => {
            location.href = `http://localhost/Projet/views/Backoffice/Evenement.php?updateEvent=${id}`
        }
