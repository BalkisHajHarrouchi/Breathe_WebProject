...
if (isset($_GET["removecmnt"]) && !empty($_GET["removecmnt"])) {
    ...
    header('location: http://localhost/projet/views/Backoffice/ListCmnt.php');
}
                ...
                <div class="table-wrapper">
                    <div class="recent-orders">
                        <table border="1" id="myTable">
                            <thead>
                                <th col-index=1>id comment</th>

                                <th col-index=2>id blog
                                    <select class="table-filter" onchange="filter_rows()">
                                        <option value="all"></option>
                                    </select>
                                </th>

                                <th col-index=3>contenu
                                    <select class="table-filter" onchange="filter_rows()">
                                        <option value="all"></option>
                                    </select>
                                </th>

                                <th col-index=4>Actions</th>
                            </thead>
                            <tbody>
                                <?php
                                for ($i = 0; $i < count($listcmnts); $i++) {
                                ?>
                                    <tr>
                                        <td><?= $listcmnts[$i]["idCommentaire"]; ?></td>
                                        <td><?= $listcmnts[$i]["idBlog"]; ?></td>
                                        <td><?= $listcmnts[$i]["contenu"]; ?></td>
                                        <td><button class="removeBtn" onclick="removecmnt(<?= $listcmnts[$i]['idCommentaire']; ?>)">Supprimer</button>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
